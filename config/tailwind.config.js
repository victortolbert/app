...
const angelArmiesColors = require('./angel_armies/colors')
const boosterColors = require('./booster/colors')
const defaultColors = require('./__DEFAULT__/colors')
const emaColors = require('./ema/colors')
const gaSpsColors = require('./ga_sps_org/colors')
const promiseServesColors = require('./promise_serves/colors')
