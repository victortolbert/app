    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center">
          ...
          <!-- Branding_container -->
          <div class="flex items-center flex-shrink-0 h-8">
            <NuxtLink
              class="flex items-center flex-shrink-0 m-2"
              :to="localePath('/')"
            >
              <IconPromiseServes
                class="h-8 mr-2 text-blue-900 dark:text-gray-100"
              />
              <span class="font-black">Promise Serves Software</span>
            </NuxtLink>
          </div>
          ...
          >
            ...
            >
              <div>
                <button
                  @click="open = !open"
                  class="flex items-center text-xs tracking-wide uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
                  id="options-menu"
                  aria-haspopup="true"
