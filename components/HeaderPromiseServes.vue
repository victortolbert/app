<template>
  <header x-data="{ open: false }" class="bg-white shadow">
      ...
      <div class="flex justify-between h-16">
        <div class="flex px-2 lg:px-0">
          ...
          <div class="flex items-center flex-shrink-0">
            <NuxtLink
              class="flex items-baseline flex-shrink-0 m-2"
              :to="localePath('/')"
            >
              <img
                src="~assets/img/logos/logo-promiserves.png"
                class="w-auto h-8"
              />

              <!-- <span class="flex items-center space-x-1">
                <IconPromiseServes />
                <span class="hidden font-black sm:block"> Promise Serves </span>
              </span> -->
            </NuxtLink>
          </div>
          ...
          >
            <a
              href="#"
              class="px-3 py-2 text-sm font-medium text-gray-900 bg-gray-100 border-transparent rounded-md shadow"
            >
              All Affiliates
            </a>
    ...
    <!-- Breadcrumbs -->
    <div class="px-4 mx-auto bg-gray-50">
      <div class="py-3 border-t border-gray-200 sm:px-6">
    ...
    <div
      ...
      class="absolute top-0 right-0 z-30 w-full p-2 transition origin-top transform max-w-none lg:hidden"
      style="display: none"
    >
      <div
