  ...
  >
    <g transform="translate(-74.633)">
      <path
        ...
        fill="#264de4"
      />
      <path d="m376.03 447.246 28.24-316.352h-148.27v349.629z" fill="#2965f1" />
      <g fill="#ebebeb">
        <path d="m150.31 268.217 4.07 45.41h101.62v-45.41z" />
        <path d="m256 176.305h-.157-113.711l4.128 45.411h109.74z" />
        <path
          d="m256 433.399v-47.246l-.199.053-50.574-13.656-3.233-36.217h-24.575-21.01l6.362 71.301 93.02 25.823z"
        />
      </g>
