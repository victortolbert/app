<template>
  <transition-group tag="div">
    ...
    <div @click="addPlace" class="side-icon" key="sideicon">
      ...
      <IconBase v-else icon-name="plus" class="plus" width="18" height="18">
        <IconPlus />
      </IconBase>
    </div>
    ...
    <aside key="aside">
      <p class="map-pin">
        <IconBase icon-name="map pin" width="18" height="18">
          <IconMapPin />
        </IconBase>
        United States
      </p>
      ...
      <p class="calendar">
        <IconBase icon-name="calendar" width="18" height="18">
          <IconCalendar />
        </IconBase>
...
import {TimelineMax, Sine, Expo, Back} from 'gsap'
