...
<template>
  <li :class="devaDayClassNames" @click="revealSurprise">
    ...
    <div v-else>
      <img
        class="deva-day-icon"
        :src="require(`../assets/img/advent-2021/${day.icon}.svg`)"
      />
      <button
...
.deva-day.has-cover {
  background-image: url('../assets/img/advent-2021/bg-dots.png');
}
.deva-day.is-ready {
  background-image: url('../assets/img/advent-2021/stars@2x.png');
