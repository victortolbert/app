  ...
  >
    ...
    <div class="nav-wrapper">
      <nav>
        ...
        <AppMenuDrawer :menu-opened="menuOpened" />

        <AppNavTransition />

        <AppStats v-if="page === 'home'" :selected-user="selectedUser" />
      </nav>
    </div>
  </header>
</template>
...
.header-img1 {
  @include header('~assets/example/header1.jpg');
}

.header-img2 {
  @include header('~assets/example/header2.jpg');
}

.header-img3 {
  @include header('~assets/example/header3.jpg');
}
