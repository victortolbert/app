<template>
  <div class="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700">
    <p class="p-4 font-bold text-black text-md dark:text-white">
      My Tasks
      <span
        class="ml-2 text-sm text-gray-500 dark:text-gray-300 dark:text-white"
      >
        (05)
      </span>
    </p>
    <ul>
      ...
      >
        <div class="flex items-center justify-start text-sm">
          ...
          <span
            class="flex items-center ml-2 text-gray-400 lg:ml-6 dark:text-gray-300"
          >
            3
            <svg
              width="15"
      ...
      <li
        class="flex items-center justify-between py-3 text-gray-600 dark:text-gray-200"
      >
        <div class="flex items-center justify-start text-sm">
