<template>
  <div>
    ...
    <dl
      class="grid grid-cols-1 mt-5 overflow-hidden bg-white divide-y divide-gray-200 shadow dark:divide-gray-600 dark:bg-gray-700 lg:rounded-lg md:grid-cols-3 md:divide-y-0 md:divide-x"
    >
      <div>
