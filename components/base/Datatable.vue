  ...
  <section>
    ...
    <article class="mt-4">
      ...
      >
        ...
        <template #empty>Blank State</template>
        ...
        <OTableColumn v-slot="props" field="id" label width="40">
          <!-- <OButton
            size="small"
        ...
        <OTableColumn
          ...
          width="250"
          label="First Name"
        >{{ props.row.user.first_name }}</OTableColumn>
        ...
        <OTableColumn field="user.last_name" searchable sortable width="250" label="Last Name">
          ...
          <template #default="props">{{ props.row.user.last_name }}</template>
        </OTableColumn>
        ...
        <OTableColumn
          ...
          cell-class="bg-redd-600"
          centered
        >{{ new Date(props.row.date).toLocaleDateString() }}</OTableColumn>

        <OTableColumn v-slot="props" label="Gender">
          <span>
            <OIcon pack="fas" :icon="props.row.gender === 'Male' ? 'mars' : 'venus'" />
            {{ props.row.gender }}
          </span>
        </OTableColumn>
      </OTable>
