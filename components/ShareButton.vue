  ...
  <div class="share-button">
    ...
    >
      ...
      <span
        ...
        v-html="$t('copy_and_share_button')"
      />
    </button>
    <span class="text-sm lg:hidden" v-html="$t('copy_and_share_button')" />
    ...
    >
      ...
      <span class="pointer-events-none" v-html="$t('copy_and_share_button')" />
    </button>
  </div>
</template>
