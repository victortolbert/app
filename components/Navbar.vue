      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center">
          ...
          <div class="flex items-center flex-shrink-0 h-8 px-4">
            ...
            >
              <div
                class="flex items-center justify-center p-3 bg-gray-700 border rounded-full shadow"
              >
                <IconTitan class="text-white transform rotate-180 w-7 h-7" />
              </div>
              <!-- <LogoVidea class="h-8 text-blue-900" /> -->
              <!-- <LogoSalesLoft class="h-8 text-blue-900" /> -->
              <!-- <LogoBooster class="h-8 text-blue-900" /> -->
              <!-- <LogoTolbertDesign class="h-8 text-blue-900" /> -->
              <!-- <IconPromiseServes class="h-8 text-blue-900" /> -->
