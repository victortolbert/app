<template>
  <div class="flex flex-col items-center w-5/6 md:w-1/3 lg:items-stretch">
    <div
    ...
    >
      ...
      <h2
        ...
        class="mb-2 text-xl font-semibold text-center lg:mb-0"
        v-text="title"
      />
    </div>
    ...
    <p
      ...
      class="text-center text-small lg:text-left"
      v-html="itemString"
    />
...
export default defineComponent({
  ...
  setup(props) {
    return {
      itemString: computed(() =>
        props.items
          .map(i => (i.strong ? `<strong>${i.text}</strong>` : i.text))
          .join(', '),
      ),
    }
  },
