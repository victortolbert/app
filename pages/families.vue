<template>
  <PageWrapper>
    <PageHeading> {{ $t('families') }} </PageHeading>
    ...
    <SectionWrapper class="min-h-screen bg-gray-100">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <a
                href="#"
                class="flex-shrink-0 p-1 ml-5 text-gray-400 bg-white rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
              >
              ...
              <div class="relative flex-shrink-0 ml-5">
                <div>
                  <button
                    type="button"
                    class="flex bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
                    id="user-menu"
                    aria-haspopup="true"
                  >
            ...
            -->
              ...
              <a
                href="#"
                class="inline-flex items-center px-4 py-2 ml-6 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-rose-600 hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
              >
                New Post
              </a>
            </div>
        ...
        <nav class="hidden lg:hidden" aria-label="Global">
          <div class="max-w-3xl px-2 pt-2 pb-3 mx-auto space-y-1 sm:px-4">
            <a
              href="#"
              aria-current="page"
              class="block px-3 py-2 text-base font-medium text-gray-900 bg-gray-100 rounded-md"
              >Home</a
            >
          ...
          <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center max-w-3xl px-4 mx-auto sm:px-6">
              ...
              <button
                type="button"
                class="flex-shrink-0 p-1 ml-auto text-gray-400 bg-white rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
              >
                <span class="sr-only">View notifications</span>
                <!-- Heroicon name: outline/bell -->
                <svg
      ...
      <div class="py-10">
        ...
        >
          <div class="hidden lg:block lg:col-span-3 xl:col-span-2">
            <nav
              aria-label="Sidebar"
              class="sticky divide-y divide-gray-300 top-4"
            >
              <div class="pb-8 space-y-1">
                ...
                >
                  ...
                  <svg
                    class="flex-shrink-0 w-6 h-6 mr-3 -ml-1 text-gray-500"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
          ...
          <main class="lg:col-span-9 xl:col-span-6">
            <div class="px-4 sm:px-0">
              <div class="sm:hidden">
                ...
                <select
                  id="question-tabs"
                  class="block w-full text-base font-medium text-gray-900 border-gray-300 rounded-md shadow-sm focus:border-rose-500 focus:ring-rose-500"
                >
              ...
              <div class="hidden sm:block">
                ...
                >
                  <a
                    href="#"
                    aria-current="page"
                    class="relative flex-1 min-w-0 px-6 py-4 overflow-hidden text-sm font-medium text-center text-gray-900 bg-white rounded-l-lg group hover:bg-gray-50 focus:z-10"
                  >
                    <span>Recent</span>
                    <span
                      aria-hidden="true"
                  ...
                  <a
                    href="#"
                    aria-current="false"
                    class="relative flex-1 min-w-0 px-6 py-4 overflow-hidden text-sm font-medium text-center text-gray-500 bg-white hover:text-gray-700 group hover:bg-gray-50 focus:z-10"
                  >
                  ...
                  <a
                    href="#"
                    aria-current="false"
                    class="relative flex-1 min-w-0 px-6 py-4 overflow-hidden text-sm font-medium text-center text-gray-500 bg-white rounded-r-lg hover:text-gray-700 group hover:bg-gray-50 focus:z-10"
                  >
              ...
              <ul class="space-y-4">
                  ...
                  <article aria-labelledby="question-title-81614">
                    ...
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        ...
                        for human safety killed what could have otherwise been
                        one of the best businesses of our generation.
                      </p>
                      <p>
                ...
                <li class="px-4 py-6 bg-white shadow sm:p-6 sm:rounded-lg">
                  <article aria-labelledby="question-title-89019">
                    ...
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        Man I am glad you asked this question. I'm a 6 year old
                        golden retriever and while I still have a few years left
                        to experience, I think I've been around long enough to
                        tell you what it's really like.
                      </p>
                      <p>
                        Most people think being a dog is awesome. You sleep as
                        much as you want, all of your meals are prepared for
                        you, and someone literally picks up your poop you. And
                        yeah, you know what, those parts <em>are</em> pretty
                        awesome. But there's a dark side to being a golden
                        retriever that they don't tell you about&hellip;
                      </p>
                    </div>
                    <div class="flex justify-between mt-6 space-x-8">
                      <div class="flex space-x-6">
                ...
                <li class="px-4 py-6 bg-white shadow sm:p-6 sm:rounded-lg">
                  <article aria-labelledby="question-title-92742">
                    ...
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        This is something most people wonder about themselves at
                        least 4 or 5 times throughout their life. Everyone
                        ignores you for weeks on end (including your immediate
                        family) and the only person who will talk to you is a
                        little boy you are treating because he thinks he sees
                        dead people.
                      </p>
                      <p>
                        The fact is, you can't <em>really</em> know if you're
                        just a weird dead ghost thing until the rest of the
                        world finally decides to acknowledge you again. But
                        there are a few things you can test that are generally
                        <em>correlated</em> with not being a weird dead ghost
                        thing, namely&hellip;
                      </p>
                    </div>
                    <div class="flex justify-between mt-6 space-x-8">
                ...
                <li class="px-4 py-6 bg-white shadow sm:p-6 sm:rounded-lg">
                  <article aria-labelledby="question-title-41150">
                    <div>
                      ...
                      <h2
                        id="question-title-41150"
                        class="mt-4 text-base font-medium text-gray-900"
                      >
                        What&#039;s the most unforgettable meal you&#039;ve ever
                        had?
                      </h2>
                    </div>
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        One time we ordered a pizza from this local place
                        downtown we'd always wanted to try. Everyone told us it
                        was the best pizza they'd ever had in their entire lives
                        and we couldn't wait to see what it was all about.
                      </p>
                      <p>
                        We placed the order at 5:45pm and it showed up at around
                        6:30pm. We opened the box excited to take in the aroma
                        of this incredible pie, but we were not prepared for
                        what we saw. Instead of the pepperoni pizza we ordered,
                        they had delivered us a&hellip;
                      </p>
                    </div>
                    <div class="flex justify-between mt-6 space-x-8">
                      <div class="flex space-x-6">
                ...
                <li class="px-4 py-6 bg-white shadow sm:p-6 sm:rounded-lg">
                  <article aria-labelledby="question-title-62760">
                    ...
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        Great question. The first thing you need to decide is
                        should your finishing move be something you do to hurt
                        your opponent enough to then get the pin, or a
                        submission move that causes your opponent to give up.
                      </p>
                      <p>
                        Personally, I've always found submission moves to be a
                        lot less exciting than a powerbomb or a moonsault off
                        the top rope. Sure there's a few classics that the crowd
                        goes nuts for like the Sharpshooter, but most of them
                        just don't get the same pop as a Tombstone or a Stone
                        Cold Stunner. If I had to choose, my first choice would
                        be&hellip;
                      </p>
                    </div>
                    <div class="flex justify-between mt-6 space-x-8">
                ...
                <li class="px-4 py-6 bg-white shadow sm:p-6 sm:rounded-lg">
                  <article aria-labelledby="question-title-41387">
                    ...
                    <div class="mt-2 space-y-4 text-sm text-gray-700">
                      <p>
                        Magnets are an incredibly interesting natural
                        phenomenon, with their discovery dating back at least
                        2500 years.
                      </p>
                      <p>
                        Scientists will tell you a bunch of stuff about how in
                        magnetic materials, most of the electrons spin in the
                        same direction. Somehow that apparently magically makes
                        random bits of metal stick together. Sure, okay
                        scientists. Here's the truth, what they don't want you
                        to know&hellip;
                      </p>
                    </div>
                    <div class="flex justify-between mt-6 space-x-8">
                    ...
                    <div class="flow-root mt-6">
                      <ul class="-my-4 divide-y divide-gray-200">
                        ...
                        <li class="flex py-4 space-x-3">
                          ...
                          <div class="flex-1 min-w-0">
                            <p class="text-sm text-gray-800">
                              Have you ever lied about your age to buy a
                              kid&#039;s meal at a restaurant?
                            </p>
                            <div class="flex mt-2">
                              <span class="inline-flex items-center text-sm">
                                <button
