...
<template>
  ...
  >
    ...
    <div class="toolbar">
      ...
      <label> <input v-model="pageMode" type="checkbox" /> page mode </label>
      <label v-if="pageMode">
        <input v-model="pageModeFullPage" type="checkbox" /> full page
      </label>
      <span>
        <input v-model.number="buffer" type="number" min="1" max="500000" />
        buffer
      </span>
      <span>
    ...
    <div v-if="renderScroller" v-show="showScroller" class="content">
      <div class="wrapper">
        <RecycleScroller
        ...
        >
          <template v-slot="props">
            ...
            >
              ...
              <div class="td value">{{ props.item.value }} Scoped</div>
            </div>
            <Player
