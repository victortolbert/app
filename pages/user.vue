...
export default {
  async asyncData({app}) {
    return {
      user: await app.$api.users.show(1),
    }
  },
  methods: {
    async loadTwo() {
      this.user = await this.$api.users.show(2)
    },
  },
}
</script>
...
<template>
  <div style="max-height: 800px" class="overflow-y-auto">
    <div class="min-h-screen bg-gray-100">
      <header
        x-data="{ open: false }"
        class="pb-24 bg-gradient-to-r from-light-blue-800 to-cyan-600"
      >
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          >
            ...
            <div class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
              <button
                type="button"
                class="flex-shrink-0 p-1 rounded-full text-cyan-200 hover:text-white hover:bg-white hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-white"
              >
              ...
              >
                ...
                <div
                  ...
                  class="absolute z-40 w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg -right-2 ring-1 ring-black ring-opacity-5"
                  role="menu"
            ...
            <div class="flex-1 min-w-0 px-12 lg:hidden">
              <div class="w-full max-w-xs mx-auto">
                ...
                <div class="relative text-white focus-within:text-gray-600">
                  ...
                  <input
                    id="search"
                    class="block w-full py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder-white bg-white border border-transparent rounded-md bg-opacity-20 focus:outline-none focus:bg-opacity-100 focus:border-transparent focus:placeholder-gray-500 focus:ring-0 sm:text-sm"
                    placeholder="Search"
                    type="search"
                    name="search"
                  />
            ...
            <div class="absolute right-0 flex-shrink-0 lg:hidden">
              <!-- Mobile menu button -->
              <button
                class="inline-flex items-center justify-center p-2 bg-transparent rounded-md text-cyan-200 hover:text-white hover:bg-white hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-white"
                x-bind:aria-expanded="open"
                @click="open = !open"
              >
            ...
            <div class="grid items-center grid-cols-3 gap-8">
              <div class="col-span-2">
                <nav class="flex space-x-4">
                  <a
                    href="#"
                    class="px-3 py-2 text-sm font-medium text-white bg-white bg-opacity-0 rounded-md hover:bg-opacity-10"
                    aria-current="page"
                  >
                    Home
                  </a>
                  ...
                  <a
                    href="#"
                    class="px-3 py-2 text-sm font-medium bg-white bg-opacity-0 rounded-md text-cyan-100 hover:bg-opacity-10"
                    aria-current="false"
                  >
                    Profile
                  </a>
        ...
        <div
          ...
          class="absolute inset-x-0 top-0 z-30 w-full max-w-3xl p-2 mx-auto transition origin-top transform lg:hidden"
          style="display: none"
        >
          <div
          ...
          >
            ...
            <div class="pt-4 pb-2">
              <div class="flex items-center px-5">
                ...
                <button
                  class="flex-shrink-0 p-1 ml-auto text-gray-400 bg-white rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500"
                >
                  <span class="sr-only">View notifications</span>
                  <svg
                    class="w-6 h-6"
      ...
      <main class="pb-8 -mt-24">
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <!-- Main 3 column grid -->
          <div
            class="grid items-start grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8"
          >
            <!-- Left column -->
            <div class="grid grid-cols-1 gap-4 lg:col-span-2">
              ...
              <button @click="loadTwo">
                Load <b>$api.users.show(2)</b> from client
              </button>
              ...
              <section aria-labelledby="quick-links-title">
                ...
                >
                  ...
                  <div
                    class="relative p-6 bg-white rounded-tl-lg group focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500"
                  >
                    <div>
                      <span
                        class="inline-flex p-3 text-teal-700 rounded-lg bg-teal-50 ring-4 ring-white"
                      >
                        <svg
                          class="w-6 h-6"
                          x-description="Heroicon name: clock"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                    ...
                    <span
                      class="absolute text-gray-300 top-6 right-6 group-hover:text-gray-400"
                      aria-hidden="true"
                    >
                      <svg
                        class="w-6 h-6"
                  ...
                  <div
                    class="relative p-6 bg-white rounded-tr-lg group focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500"
                  >
                    <div>
                      <span
                      ...
                      >
                        <svg
                          class="w-6 h-6"
                          x-description="Heroicon name: badge-check"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                  ...
                  <div
                    class="relative p-6 bg-white group focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500"
                  >
                    <div>
                      <span
                        class="inline-flex p-3 rounded-lg bg-light-blue-50 text-light-blue-700 ring-4 ring-white"
                      >
                        <svg
                          class="w-6 h-6"
                  ...
                  <div
                    class="relative p-6 bg-white rounded-bl-lg group focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500"
                  >
                    <div>
                      <span
                        class="inline-flex p-3 rounded-lg bg-rose-50 text-rose-700 ring-4 ring-white"
                      >
                        <svg
                          class="w-6 h-6"
                          x-description="Heroicon name: receipt-refund"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                  ...
                  <div
                    class="relative p-6 bg-white rounded-br-lg group focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500"
                  >
                    <div>
                      <span
                        class="inline-flex p-3 text-indigo-700 rounded-lg bg-indigo-50 ring-4 ring-white"
                      >
                        <svg
                          class="w-6 h-6"
                          x-description="Heroicon name: academic-cap"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
      ...
      <footer>
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8 lg:max-w-7xl">
          <div
            class="py-8 text-sm text-center text-gray-500 border-t border-gray-200 sm:text-left"
          >
            <span class="block sm:inline">© 2021 Tailwind Labs Inc.</span>
