...
<template>
  <div>
    ...
    <div>
      ...
      <SectionWrapper :padded="false" class="bg-gray-500 border">
    ...
    <!-- Tabs -->
    <div class="py-4">
      <OTabs v-model="activeTab" expanded>
        <OTabItem label="Profile">
          <!-- Description list -->
              ...
              <div class="sm:col-span-2">
                ...
                <dd class="mt-1 text-sm text-gray-900 max-w-prose">
                  ...
                  <p class="mt-5">
                    ...
                    platea rhoncus ac mauris amet. Urna, sem pretium sit pretium
                    urna, senectus vitae. Scelerisque fermentum, cursus felis
                    dui suspendisse velit pharetra. Augue et duis cursus
                    maecenas eget quam lectus. Accumsan vitae nascetur pharetra
