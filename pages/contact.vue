...
<template>
  <form @submit.prevent="handleSubmit" class="relative bg-white">
          ...
          <dl class="mt-8 text-base text-gray-500">
            ...
            <div class="mt-3">
              ...
              <dd class="flex">
                ...
                <span class="ml-3"> info@promise686.org </span>
              </dd>
            </div>
          </dl>
        ...
        <div class="max-w-lg mx-auto lg:max-w-none">
          <form action="#" method="POST" class="grid grid-cols-1 gap-y-6">
            ...
            <div>
              <button
                type="submit"
                class="inline-flex justify-center px-6 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              >
                Submit
              </button>
            </div>
