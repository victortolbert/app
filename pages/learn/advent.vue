<script>
import devAdventData from '../../content/_data/2021-advent.json'
...
<template>
  <main class="dev-advent-page">
    <article class="dev-advent-wrapper">
      <h1 class="daw-title">DevAdvent Calendar</h1>
      <p class="daw-description">
...
.dev-advent-page {
  ...
  background-image: url('../../assets/img/advent-2021/bg-snowflake.png');
}
.dev-advent-wrapper {
  max-width: 766px;
  margin: 0 auto;
