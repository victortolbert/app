...
!(function () {
  ...
  var e = window,
    ...
    o = s.documentElement,
    a = ['dark', 'light'],
    t = window.localStorage.getItem('nuxt-color-mode') || 'system',
    c = 'system' === t ? l() : t,
  ...
  function l() {
    if (e.matchMedia && 'not all' !== n('').media)
      for (var s of a) if (n(':' + s).matches) return s
    return 'light'
  }
  i && (c = i),
    r(c),
    (e['__NUXT_COLOR_MODE__'] = {
      preference: t,
      value: c,
      getColorScheme: l,
      addClass: r,
      removeClass: function (e) {
        ...
        o.classList
          ...
          : (o.className = o.className.replace(new RegExp(s, 'g'), ''))
      },
    })
})()
