...
const CompositionApi__default = /*#__PURE__*/ _interopDefaultLegacy(
  CompositionApi,
)
...
const ssrValue = (value, key, type = 'globalRefs') => {
  ...
  if (process.client) {
    if (
      ...
      ((_a = window[globalNuxt]) == null ? void 0 : _a.context.isHMR)
    ) {
      return getValue(value)
    }
    return (_d =
      (_c = (_b = window[globalContext]) == null ? void 0 : _b[type]) == null
        ? void 0
        : _c[key]) != null
      ? _d
      : getValue(value)
...
const setFetchState = vm => {
  vm.$fetchState =
    vm.$fetchState ||
    Vue__default['default'].observable({
      error: null,
      pending: false,
      timestamp: 0,
    })
...
const staticPath =
  '/Users/vtolbert/@victortolbert/_github/APP/.nuxt-storybook/static-json'
const staticCache = {}
