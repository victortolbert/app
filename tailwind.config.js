  ...
  theme: {
    ...
    configViewer: {
      themeReplacements: {
        ...
        'var(--color-primary)': '#98002f',
        'var(--color-primary-50)': '#faf2f5',
        'var(--color-primary-100)': '#f5e6ea',
        'var(--color-primary-200)': '#e5bfcb',
        'var(--color-primary-300)': '#d699ac',
        'var(--color-primary-400)': '#b74d6d',
        'var(--color-primary-500)': '#98002f',
        'var(--color-primary-600)': '#89002a',
        'var(--color-primary-700)': '#720023',
        'var(--color-primary-800)': '#5b001c',
        'var(--color-primary-900)': '#4a0017',
        'var(--color-secondary)': '#16abe4',
        'var(--color-secondary-50)': '#f3fbfe',
        'var(--color-secondary-100)': '#e8f7fc',
        'var(--color-secondary-200)': '#c5eaf8',
        'var(--color-secondary-300)': '#a2ddf4',
        'var(--color-secondary-400)': '#5cc4ec',
        'var(--color-secondary-500)': '#16abe4',
        'var(--color-secondary-600)': '#149acd',
        'var(--color-secondary-700)': '#1180ab',
        'var(--color-secondary-800)': '#0d6789',
        'var(--color-secondary-900)': '#0b5470',
        'var(--color-tertiary)': '#0e50a9',
        'var(--color-tertiary-50)': '#f3f6fb',
        'var(--color-tertiary-100)': '#e7eef6',
        'var(--color-tertiary-200)': '#c3d3ea',
        'var(--color-tertiary-300)': '#9fb9dd',
        'var(--color-tertiary-400)': '#5685c3',
        'var(--color-tertiary-500)': '#0e50a9',
        'var(--color-tertiary-600)': '#0d4898',
        'var(--color-tertiary-700)': '#0b3c7f',
        'var(--color-tertiary-800)': '#083065',
        'var(--color-tertiary-900)': '#072753',
      }
    }
  },
  variants: {
